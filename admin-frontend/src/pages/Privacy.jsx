...
import { ClockIcon, ArrowDownTrayIcon, CheckCircleIcon, XCircleIcon } from '../components/Icons';
  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
      ...
      >
        ...
        >
          {exportLoading ? <><ClockIcon style={{ width: "20px", height: "20px", strokeWidth: 2, display: "inline", marginRight: "6px" }} />Подготвя се...</> : <><ArrowDownTrayIcon style={{ width: "20px", height: "20px", strokeWidth: 2, display: "inline", marginRight: "6px" }} />Изтегли данните ми</>}
        </button>
      </div>
        ...
        {!showDeleteForm ? (
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              ...
              >
                <XCircleIcon style={{ width: "20px", height: "20px", strokeWidth: 2, display: "inline", marginRight: "6px" }} />
                Отказ
              </button>
            </div>
          </div>
