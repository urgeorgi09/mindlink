        ...
        <div style={{ 
          ...
          {[
            ...
            <div
              ...
              style={{
                background: activeFeature === index ? 'white' : '#ffffff',
                padding: '40px',
                borderRadius: '20px',
                border: activeFeature === index ? '2px solid #6da65f' : '1px solid #d4edda',
                cursor: 'pointer',
                transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                transform: activeFeature === index ? 'translateY(-8px) scale(1.02)' : 'translateY(0) scale(1)',
                boxShadow: activeFeature === index ? '0 20px 60px rgba(109, 166, 95, 0.2)' : '0 4px 16px rgba(109, 166, 95, 0.08)'
              }}
