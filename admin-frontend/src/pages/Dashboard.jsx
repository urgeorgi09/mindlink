...
import { Cog6ToothIcon, CheckCircleIcon, CameraIcon } from '../components/Icons';
  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "40px 20px" }}>
      ...
      >
        ...
        >
          {!profile.profileImage && <CameraIcon style={{ width: "60px", height: "60px", strokeWidth: 1.5, color: "#9333ea" }} />}
        </div>
      ...
      >
        ...
        >
          {saving ? <><Cog6ToothIcon style={{ width: "20px", height: "20px", strokeWidth: 2, display: "inline", marginRight: "6px" }} />Запазване...</> : <><CheckCircleIcon style={{ width: "20px", height: "20px", strokeWidth: 2, display: "inline", marginRight: "6px" }} />Запази промените</>}
        </button>
      </div>
    </div>
  );
